<?php 
    ...
    $select_posts_by_id = mysqli_query($connection, $query) or die ("problem with the query ".mysqli_error($connection));     
    ...
    if(isset($_POST["update_post"])){
        ...
        if(empty($post_image)){
            $query = "SELECT * FROM posts WHERE post_id = $the_post_id";
            $select_image = mysqli_query($connection, $query) or die ("problem with the query ".mysqli_error($connection));  
        ...
        $edit_post = mysqli_query($connection, $query) or die ("problem with the query ".mysqli_error($connection));  
    }
